...
import re # Importado para usar expressões regulares na busca
...
# <<<< MODIFICADO: Prompt atualizado para 4 categorias (40 perguntas) >>>>
PROMPT_TEMPLATE = """
# CONTEXTO E PERSONA
...
# TAREFA PRINCIPAL
Com base **EXCLUSIVAMENTE** no conteúdo dos documentos fornecidos em `[DOCUMENTOS FORNECIDOS]`, gere um total de **40 perguntas**, divididas igualmente entre as 4 categorias a seguir (exatamente 10 perguntas por categoria).
...
{{
  "id": "ID_UNICO_PARA_CADA_PERGUNTA",
