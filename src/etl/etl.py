# ==================================================================================================
# PIPELINE DE INGESTÃO E PROCESSAMENTO (v5.7 - Modelo text-embedding-3-small)
#
# DESCRIÇÃO:
# - Configurado para usar o 'text-embedding-3-small' como nome de modelo.
# - Adiciona a chave 'documento_origem' na metadata para permitir citações corretas pela API.
# ==================================================================================================
...
if os.path.exists(dotenv_path): logging.info(f"Arquivo .env encontrado e carregado de: {dotenv_path}")
else: logging.warning("Arquivo .env NÃO encontrado.")
